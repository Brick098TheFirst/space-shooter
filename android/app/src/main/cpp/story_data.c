...
const StoryLevel g_story_levels[STORY_LEVEL_COUNT] = {
    ...
    { "LOST RELAY",
      "An old Chubb relay went quiet.",
      "Jack searches it for useful tech.",
    ...
    { "RUSTJAW",
      "Rustjaw guards the way out.",
      "Jack, break those iron teeth.",
    ...
    { "DEAD ENGINES",
      "Cold engines wake among the scrap.",
      "Hunt each signal down.",
    ...
    { "MAGNET WELL",
      "Yard magnets drag at the ship.",
      "Keep moving through their pull.",
    ...
    { "THE TWINS",
      "The Twins run the Rust Yards.",
      "Two ships, one way through.",
    ...
    { "SNOWBLIND",
      "Ice dust hides every landmark.",
      "Jack flies by the scanner.",
    ...
    { "WIDOW'S WEB",
      ...
      "Cut a route to Frostwidow.",
      OBJ_TIMED, 22, 8, 105, 158, 216, 480, MOD_BOULDERS },
    { "FROSTWIDOW",
      "Frostwidow waits under the ice.",
    ...
    { "BOLT RUN",
      "Loose bolts fly faster than bullets.",
      "Hunt the gunners behind them.",
    ...
    { "SCRAP TITAN",
      "The Scrap Titan blocks every lane.",
    ...
    { "MOLTEN DRIFT",
      "Burning rocks roll through the Reach.",
      "Crack the largest before they burst.",
    ...
    { "HEAT TRAP",
      "The safe lane is melting shut.",
      "Jack has seconds to escape.",
    ...
    { "LASH GUARD",
      "Emberlash's guard holds the gate.",
      "Break their formation.",
      OBJ_HUNT, 38, 7, 65, 190, 296, 1200, MOD_SNIPERS },
    { "EMBERLASH",
      "Emberlash burns across the stars.",
    ...
    { "OLD RECORDS",
      "The Chubbs' lost records are here.",
      "Guard them while the ship copies.",
    ...
    { "MIRROR FIELD",
      "Reflections copy every shot.",
      "Jack fires when the path is clear.",
    ...
    { "BROKEN SKY",
      "Cracks split the sky above Jack.",
      "Race through before they close.",
    ...
    { "THRONE ROAD",
      "The Queen's last defense arrives.",
...
static const char* const s_boss_taunts[STORY_SECTOR_COUNT] = {
    "MY TEETH HAVE CRUSHED BETTER SHIPS.",
    "WE SEE YOU, JACK. BOTH OF US.",
    "YOUR REVENGE FREEZES WITH YOU.",
    "JACK WILL JOIN THE SCRAPLINE.",
    "YOUR LITTLE SHIP WILL BURN.",
    "NO ONE LEAVES THE COLD VAULT.",
    "JACK ARKEY. COME FACE REALITY."
};
